...
```text
Tu es intégré dans un système d'agence autonome nommé laNostr'AI / EURKAI.
...
def _build_analyze_prompt(builder_state: dict) -> str:
    ...
    prompt = f"""Tu es intégré dans un système d'agence autonome nommé laNostr'AI / EURKAI.
