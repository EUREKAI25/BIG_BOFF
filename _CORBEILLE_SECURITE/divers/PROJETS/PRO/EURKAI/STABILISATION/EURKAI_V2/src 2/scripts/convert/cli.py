...
from EURKAI_audit import audit_file, parse_js_file, analyze, generate_report
from EURKAI_convert import convert_file
...
def main():
    parser = argparse.ArgumentParser(
        description='EURKAI Code Service - Audit et conversion JS → Python',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemples:
  EURKAI audit traverse.js                    # Audit avec rapport YAML
  EURKAI audit traverse.js -f markdown        # Rapport Markdown
  EURKAI convert traverse.js -o ./out         # Conversion complète
  EURKAI info traverse.js                     # Infos rapides
        """
    )
