...
_INDUSTRY_NORMALIZE: dict[str, str] = {
    ...
    "developer tools":  "b2b_enterprise",
    "developer tool":   "b2b_enterprise",
    "devops":           "b2b_enterprise",
    "engineering":      "b2b_enterprise",
    "data platform":    "b2b_enterprise",
    "data infrastructure": "b2b_enterprise",
    "media_editorial":  "media_editorial",
    "editorial":        "media_editorial",
    "magazine":         "media_editorial",
    "publishing":       "media_editorial",
    "literary":         "media_editorial",
    "art journal":      "media_editorial",
    "nightlife_event":  "nightlife_event",
    "nightlife":        "nightlife_event",
    "event":            "nightlife_event",
    "festival":         "nightlife_event",
    "club":             "nightlife_event",
}
