...
from .schemas import LogoDNA, LogoStructure, LogoConcept, ArbitrationConfig
from .prompt_builder import build_concept_prompts, _resolve_structure
...
def generate_concepts(
    ...
    La LogoStructure est lue depuis dna.logo_structure (fallback: ICON_WORDMARK).

    Args:
        dna:            LogoDNA de la marque (contient logo_structure)
    ...
    prompts = build_concept_prompts(dna, n=config.n_concepts)
